...
export const EN_MESSAGES: MessageCatalog = {
  ...
  "会话": "Session",
  "用时 / 首响 / 输出速率": "Duration / first response / output rate",
  "Guard 命中后已在网关内部重试并恢复。":
    "The Guard match was recovered by an internal gateway retry.",
  "官方实际费用": "Official actual cost",
  "本地估算": "Local estimate",
  "长上下文": "Long context",
  "阈值": "Threshold",
  "规则": "Rule",
  "单档价格": "Single-tier pricing",
  "兼容候选": "Compatibility candidate",
  "普通": "Standard",
  "写入": "Write",
  "计费": "Billable",
  "首响表示从请求开始到首个上游响应片段的耗时；输出速率按输出 Token / 总用时计算":
    "First response measures the time from request start to the first upstream response chunk; output rate is output tokens divided by total duration.",
  "历史长上下文候选": "Historical long-context candidate",
  "输入超过当前长上下文阈值，但历史日志未保存实际计价规则。":
    "The input exceeded the current long-context threshold, but the historical log did not preserve the actual pricing rule.",
  ...
  当前筛选结果中的缓存率: "Cache rate in the current filtered result",
  输入标题: "Enter title",
  全部平台密钥: "All API keys",
  "匹配会话标题、父标题或会话 ID": "Matches session title, parent title, or session ID",
  按平台模型筛选请求: "Filter requests by platform model",
  按平台密钥筛选请求: "Filter requests by API key",
  未命名密钥: "Unnamed key",
  Token: "Token",
  缓存率: "Cache rate",
  费用: "Cost",
  ...
  异常请求次数: "Failed",
  累计费用: "Total cost",
  当前筛选结果中的累计费用: "Total cost in the current selection",
  当前视图: "Current view",
  总日志: "Total logs",
  "2XX 成功": "2XX Success",
  ...
  跟随当前筛选: "Follows current filters",
  个模型: "models",
  "仅展示费用最高的 50 个模型": "Showing the top 50 models by cost",
  费用占比: "Cost share",
  当前筛选下暂无模型用量: "No model usage under current filters",
  "不含 Guard 重试用量": "Excludes Guard retry usage",
  展开全部: "Expand all",
  收起: "Collapse",
  成功: "Success",
  请求: "Requests",
