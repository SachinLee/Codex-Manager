...
export const KO_ACCOUNTS_MESSAGES: MessageCatalog = {
  "额度重置自动唤醒": "할당량 초기화 시 자동 깨우기",
  "自动唤醒：开": "자동 깨우기: 켜짐",
  "自动唤醒：关": "자동 깨우기: 꺼짐",
  "开启额度重置自动唤醒": "할당량 초기화 시 자동 깨우기 켜기",
  "关闭额度重置自动唤醒": "할당량 초기화 시 자동 깨우기 끄기",
  "批量开启自动唤醒": "선택한 계정 자동 깨우기 켜기",
  "批量关闭自动唤醒": "선택한 계정 자동 깨우기 끄기",
  "已为 {count} 个账号开启额度重置自动唤醒": "계정 {count}개의 할당량 초기화 시 자동 깨우기를 켰습니다",
  "已为 {count} 个账号关闭额度重置自动唤醒": "계정 {count}개의 할당량 초기화 시 자동 깨우기를 껐습니다",
  "更新额度重置自动唤醒失败: {error}": "할당량 초기화 시 자동 깨우기 변경 실패: {error}",
  "5 小时额度用尽后，在重置时间到达时自动发送一条预热消息，提前启动下一轮额度周期。默认开启，可单独或批量关闭。":
    "5시간 할당량을 모두 사용한 후 초기화 시각이 되면 준비 메시지를 자동으로 보내 다음 할당량 주기를 더 일찍 시작합니다. 기본으로 켜져 있으며 계정별 또는 일괄로 끌 수 있습니다.",
