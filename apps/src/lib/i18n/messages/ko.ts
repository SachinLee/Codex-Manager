...
export const KO_MESSAGES: MessageCatalog = {
  ...
  仪表盘: "대시보드",
  本月: "이번 달", 标题: "제목", "标题：": "제목:", 待移动: "이동 대기", "调试端口：": "디버그 포트:", 个会话: "개 세션", "个会话及其本地数据，删除后可在 30 天内通过备份令牌撤销。": "개 세션 및 로컬 데이터가 삭제됩니다. 백업 토큰으로 30일 이내에 취소할 수 있습니다.", "个已归档会话及其本地数据。": "개의 보관된 세션 및 로컬 데이터.", 归档: "보관", 还有: "추가", 会话管理: "세션 관리", 即将删除: "삭제 예정", 即将删除全部: "모두 삭제 예정", "即将删除以下会话及其本地数据，删除后可在 30 天内通过备份令牌撤销。": "다음 세션과 로컬 데이터가 삭제됩니다. 백업 토큰으로 30일 이내에 취소할 수 있습니다.", "近 3 个月": "최근 3개월", "路径：": "경로:", 没有匹配当前筛选条件的会话: "현재 필터와 일치하는 세션이 없습니다", 没有匹配的项目目录: "일치하는 프로젝트 디렉터리가 없습니다", 目标目录: "대상 디렉터리", "普通启动 Codex 并使用 Codex-Manager 会话管理；注入模式仅作为旧增强能力保留": "Codex를 일반적으로 시작하고 Codex-Manager로 세션을 관리합니다. 주입 모드는 레거시 향상 기능으로만 유지됩니다.", 确认批量删除会话: "세션 일괄 삭제 확인", 确认删除会话: "세션 삭제 확인", 确认删除已归档会话: "보관된 세션 삭제 확인", 日期范围: "날짜 범위", 删除选中: "선택 항목 삭제", 删除已归档: "보관된 항목 삭제", 上月: "지난달", 所属项目: "프로젝트", "所属项目：": "프로젝트:", 探测路径: "경로 탐색", 停止: "중지", "同步 Provider": "Provider 동기화", 未归档: "미보관", 无标题: "제목 없음", 项目目录: "프로젝트 디렉터리", 选择会话: "세션 선택", "选择目标工作目录，确认后会更新 Codex 会话所属项目。": "대상 작업 디렉터리를 선택하세요. 확인하면 Codex 세션 프로젝트가 업데이트됩니다.", 移动选中: "선택 항목 이동", "暂无会话数据（需先启动 Codex）": "세션 데이터가 없습니다(Codex를 먼저 시작하세요)", 暂无可用目标目录: "사용 가능한 대상 디렉터리가 없습니다", 指定月份: "지정 월", 至: "까지", "Codex 启动状态": "Codex 시작 상태", "Codex App 桥接": "Codex App 브리지",
  "备份失败，未执行删除": "백업에 실패하여 삭제하지 않았습니다", 撤销: "실행 취소", "次请求": "요청", 待处理: "대기 중", "当前 Codex 会话结构不支持移动": "현재 Codex 세션 구조는 이동을 지원하지 않습니다", 登录态: "로그인 상태", 低: "낮음", 高: "높음", 工作目录: "작업 디렉터리", 归档状态: "보관 상태", 缓存写入: "캐시 쓰기", "会话 ID": "세션 ID", "会话不存在或已被删除": "세션이 없거나 삭제되었습니다", "会话更新时间结束日期": "세션 업데이트 종료 날짜", "会话更新时间开始日期": "세션 업데이트 시작 날짜", "会话已删除": "세션이 삭제되었습니다", "会话已移动": "세션이 이동되었습니다", "会话已在目标目录中": "세션이 이미 대상 디렉터리에 있습니다", 计费输入: "청구 입력", 加载中: "불러오는 중", 检查中: "확인 중", 今日使用: "오늘 사용량", 今日无请求: "오늘 요청 없음", 就绪: "준비됨", "累计 Token": "누적 토큰", 路由锚点: "라우팅 앵커", 内部重试: "내부 재시도", 配置桥接: "브리지 구성", "配置中...": "구성 중...", 普通启动: "일반 시작", 启动并注入: "시작 및 주입", 启用手机远控: "모바일 원격 제어 사용", "启用中...": "사용 설정 중...", 请选择目标目录: "대상 디렉터리를 선택하세요", 全部会话: "모든 세션", 确认移动: "이동 확인", 三: "수", 删除会话: "세션 삭제", 手机控制: "모바일 제어", "手机远程控制已启用": "모바일 원격 제어가 활성화되었습니다", "手机远程控制已是启用状态": "모바일 원격 제어가 이미 활성화되어 있습니다", 输出: "출력", 搜索会话标题或路径: "세션 제목 또는 경로 검색", 搜索目录: "디렉터리 검색", 推理输出: "추론 출력", "未记录会话 ID": "기록된 세션 ID 없음", 未命名目录: "이름 없는 디렉터리", 未匹配会话: "일치하지 않는 세션", 未运行: "실행 안 함", "未在本地 Codex 会话列表中找到匹配标题": "로컬 Codex 세션 목록에서 일치하는 제목을 찾지 못했습니다", 未注入: "주입되지 않음", 无标题会话: "제목 없는 세션", 无项目: "프로젝트 없음", 五: "금", "悬停格子查看当日 Token": "셀 위에 마우스를 올려 일일 토큰을 확인하세요", 选择当前筛选会话: "현재 필터의 세션 선택", 选择会话更新时间月份: "세션 업데이트 월 선택", 选中会话已在目标目录中: "선택한 세션이 이미 대상 디렉터리에 있습니다", 一: "월", 移动会话: "세션 이동", "移动中...": "이동 중...", 已归档: "보관됨", 已注入: "주입됨", "有请求日志后会自动生成全年活动热力图。": "요청 로그가 생기면 연간 활동 히트맵이 자동으로 생성됩니다.", 远程连接: "원격 연결", 运行中: "실행 중", "暂无 Token 活动": "토큰 활동 없음", 展开: "펼치기", "这是 Reasoning Guard 被网关保护转换成的 502，不是真实上游 502。": "이 502는 실제 업스트림 502가 아니라 게이트웨이 Reasoning Guard가 변환한 것입니다.", "注入中...": "주입 중...", 桌面授权: "데스크톱 권한", 阻断: "차단됨", "最近 token": "최근 토큰", "最近动作": "최근 작업", "App 确认": "앱 확인", "Codex 启动器": "Codex 런처", "Codex 启动器已启动，正在注入增强功能...": "Codex 런처가 시작되어 향상 기능을 주입하고 있습니다...", "Codex 已启动": "Codex가 시작되었습니다", "Codex 注入器已停止": "Codex 주입기가 중지되었습니다", "Codex App 桥接配置已写入": "Codex App 브리지 구성이 저장되었습니다", "Guard 事件": "Guard 이벤트", "Token 活动": "토큰 활동", "Token 活动读取失败": "토큰 활동을 불러오지 못했습니다", "Live Smoke": "실시간 스모크",
  概览: "개요",
  平台接入: "플랫폼 연결",
  平台配置: "플랫폼 설정",
  "延迟测试设置": "지연 시간 테스트 설정",
  ...
  "会话": "세션",
  "用时 / 首响 / 输出速率": "소요 시간 / 첫 응답 / 출력 속도",
  "Guard 命中后已在网关内部重试并恢复。":
    "Guard 적중 후 게이트웨이 내부 재시도로 복구되었습니다.",
  "官方实际费用": "공식 실제 비용",
  "本地估算": "로컬 추정",
  "长上下文": "긴 컨텍스트",
  "阈值": "임계값",
  ...
  "首响表示从请求开始到首个上游响应片段的耗时；输出速率按输出 Token / 总用时计算":
    "첫 응답은 요청 시작부터 첫 업스트림 응답 조각까지의 시간이며, 출력 속도는 출력 토큰을 총 소요 시간으로 나눈 값입니다.",
  "历史长上下文候选": "과거 긴 컨텍스트 후보",
  "输入超过当前长上下文阈值，但历史日志未保存实际计价规则。":
    "입력이 현재 긴 컨텍스트 임계값을 초과했지만 과거 로그에 실제 요금 규칙이 저장되지 않았습니다.",
  模型与路由: "모델 및 라우팅",
  成员管理: "멤버 관리",
  运行观测: "운영 관측",
  系统: "시스템",
  ...
  "开启后，同一会话（缓存亲和键）的后续请求会优先复用上一次成功的聚合 API 来源，减少切换上游导致的提示缓存失效；默认关闭。":
    "켜면 동일한 캐시 어피니티 키를 가진 후속 요청이 마지막으로 성공한 집계 API 소스를 우선 사용해, 업스트림 전환으로 인한 프롬프트 캐시 무효화를 줄입니다. 기본값은 비활성입니다.",
  ...
  当前筛选结果中的缓存率: "현재 필터 결과의 캐시율",
  输入标题: "제목 입력",
  全部平台密钥: "모든 API 키",
  "匹配会话标题、父标题或会话 ID": "세션 제목, 상위 제목 또는 세션 ID와 일치",
  按平台模型筛选请求: "플랫폼 모델로 요청 필터링",
  按平台密钥筛选请求: "API 키로 요청 필터링",
  未命名密钥: "이름 없는 키",
  Token: "Token",
  缓存率: "캐시율",
  费用: "비용",
  ...
  "子线程 ID": "하위 에이전트 ID",
  "主线程 ID": "메인 세션 ID",
  "搜索模型名称，例如 gpt-5.6...": "모델 이름 검색, 예: gpt-5.6...",
  "搜索会话标题或会话 ID...": "세션 제목 또는 세션 ID 검색...",
  "搜索路径、账号、密钥、模型或会话...": "경로, 계정, 키, 모델 또는 세션 검색...",
  跟随当前筛选: "현재 필터 기준",
  个模型: "개 모델",
  "仅展示费用最高的 50 个模型": "비용 상위 50개 모델만 표시",
  费用占比: "비용 비중",
  当前筛选下暂无模型用量: "현재 필터에 모델 사용량이 없습니다",
  "不含 Guard 重试用量": "Guard 재시도 사용량 제외",
  展开全部: "모두 펼치기",
  收起: "접기",
  成功: "성공",
  请求: "요청",
  ...
  费用倍率: "비용 배율",
  "费用倍率必须大于 0 且不超过 100":
    "비용 배율은 0보다 크고 100 이하여야 합니다",
  "最终费用 = 官方模型价格估算 × 费用倍率，留空按 1 计算。":
    "최종 비용 = 공식 모델 가격 추정치 x 비용 배율입니다. 비워 두면 1로 계산합니다.",
  上游模型覆盖: "업스트림 모델 재정의",
  留空则使用请求中的模型: "비워 두면 요청의 모델을 사용합니다",
  "用于 API 转发服务要求固定模型名的场景；连接测试和真实转发都会使用该模型。":
    "API 전달 서비스가 고정 모델명을 요구하는 경우 사용합니다. 연결 테스트와 실제 전달 모두 이 모델을 사용합니다.",
  "中 (medium)": "중간 (medium)",
  总费用: "총 비용",
