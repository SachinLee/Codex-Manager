...
pub use gateway::{
    ...
    set_gateway_capability_routing_mode, set_gateway_residency_requirement,
...
pub use shared::{
    ...
    APP_SETTING_GATEWAY_AUTO_COMPACT_ENABLED_KEY, APP_SETTING_GATEWAY_BACKGROUND_TASKS_KEY,
