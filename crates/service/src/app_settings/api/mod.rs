...
pub(super) use super::gateway::{
    ...
    current_gateway_auto_compact_enabled, current_gateway_compact_model_forward_rules,
    ...
    set_gateway_background_tasks, set_gateway_capability_routing_mode,
    set_gateway_compact_model_forward_rules,
