...
mod tests {
    ...
    fn candidate_skip_reason_for_proxy_allows_failover_when_head_account_is_inflight_limited() {
        ...
        let actual = candidate_skip_reason_for_proxy("acc-preferred", 0, 2, 1, false, false);
    ...
    fn candidate_skip_reason_for_proxy_can_skip_last_cooldown_candidate() {
        ...
        let default_last = candidate_skip_reason_for_proxy(account_id, 0, 1, 0, false, false);
        let strict_last = candidate_skip_reason_for_proxy(account_id, 0, 1, 0, true, false);
