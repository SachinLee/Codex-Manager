...
// Compact runtime cooling UI: keep badge + optional failures, move clear action into tooltip area remains
replaceOnce(
  "runtime-normal",
...
console.log({
  ...
  hasPageGap: src.includes('PageWorkspace className="gap-3"'),
});
