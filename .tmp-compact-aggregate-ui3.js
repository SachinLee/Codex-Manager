...
function replaceOnce(label, from, to) {
  ...
  // Use only first occurrence by splitting carefully
...
// also compact type/key cells a bit if present
replaceOnce(
  "type-cell-badge",
  `<TableCell>
...
console.log({
  ...
  hasMissingRouteI18n: src.includes('t("未配置模型路由")'),
  hasTableTextXs: src.includes('Table className="text-xs"'),
  hasConnectivityRow: src.includes('flex items-center gap-1.5'),
});
